...
const LearnMore = () => {
    return (
        <div>
            ...
            <div className="container mx-auto px-4 lg:px-36 mt-20 pink-bg">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
                    ...
                    <div>
                        <h2 className="text-3xl lg:text-5xl font-bold mb-4">Move faster with your tools in one place</h2>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center mt-10">
                    <div>
                        <h2 className="text-3xl lg:text-5xl font-bold mb-4">Choose how you want to work</h2>
                    ...
                    <div>
                        <video autoPlay loop muted className="w-full rounded">
                            <source src="https://a.slack-edge.com/b211f31/marketing/img/homepage/true-prospects/animations/mp4/ia4-flexibility.mp4" type="video/mp4" />
                        </video>
                    </div>
                </div>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center mt-10 pb-10">
                    <div>
                        <video autoPlay loop muted className="w-full rounded">
                            <source src="https://a.slack-edge.com/9436a9f/marketing/img/homepage/e2e-prospects/animations/mp4/connectedness.mp4" type="video/mp4" />
                        </video>
                    </div>
                    <div>
                        <h2 className="text-3xl lg:text-5xl font-bold mb-4">Bring your team together</h2>
